                    ...
                    <form action="functions/save-projects-func.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="Season" id="Season" class="form-control" placeholder="Season e.g Season 1" required>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <form action="functions/update-projects-func.php" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="project_name">Project Name</label>
                            <input type="text" name="project_name" id="project_names" class="form-control" placeholder="Project Name" required>
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="Tonage">Tonage</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="Season">Season</label>
                            <input type="text" name="Season" id="Seasons" class="form-control" placeholder="Season e.g Season 1" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount</label>
